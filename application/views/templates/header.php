   ...
   <body>
      <header id="header" class="header fixed-top d-flex align-items-center">
         <div class="d-flex align-items-center justify-content-between">
           <a href="<?= base_url('dashboard'); ?>" class="logo d-flex align-items-center"> <img src="<?= base_url('assets/'); ?>img/logo.png" alt=""> <span class="d-none d-lg-block">HMPS TBI</span> </a> <i class="bi bi-list toggle-sidebar-btn"></i></div>
